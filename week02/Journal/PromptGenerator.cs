public class PromptGenerator
{
    ...
    public string GetRandomPrompt()
    {
        ...
        // This option works, but once the count gets to 0, there are no prompts after zero... so how do you restart the count after the user presses 1 from the menu again?
        // Random r = new Random();
        ...
        // Tried to combine the two: DOESN'T WORK
    //     Random r = new Random();
    //     List<string> _uniquePrompts = new List<string>(_prompts);
    //     if (_uniquePrompts.Count == 0)
    //     {
    ...
    //     {
    //         int i = r.Next(_uniquePrompts.Count);
    //         string selectedPrompt = _uniquePrompts[i];
    //         _uniquePrompts.RemoveAt(i);
    //         return selectedPrompt;
    //     }
    // return "";        
